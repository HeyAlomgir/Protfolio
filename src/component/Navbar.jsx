...
const Navbar = () => {
    ...
    return (
        ...
        >
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className='flex items-center justify-between h-20'>
                    {/* Logo - Footer এর মতো টেক্সট-ব্যাজ স্টাইল, হালকা animation সহ */}
                    <a href='#home' className='flex items-center gap-3'>
                        <motion.div
                            ...
                            className='w-11 h-11 rounded-full flex items-center justify-center bg-gradient-to-br from-cyan-500 to-blue-600 text-white font-black text-sm ring-2 ring-cyan-400/30 flex-shrink-0'
                        >
                            AH
                        </motion.div>
